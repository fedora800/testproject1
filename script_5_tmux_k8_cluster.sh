...
tmux new-session -d -P -s ${SESSION_NAME} "bash"
...
tmux new-window -P -t ${SESSION_NAME}:6 -n ${HOSTNAME%%.*} "bash"   # this last window will be for the multiple panes

#--------------------------------------------------------------------------------


# window 6 created above has pane 1 
